...
from orm.models.comment import Comments
from orm.models.post import Post
from orm.models.user import User

from orm.schema import Query, Mutation
...
def setup_database():
    ...
    repository = DatabaseMigrationRepository(db, "orm/migrations")
